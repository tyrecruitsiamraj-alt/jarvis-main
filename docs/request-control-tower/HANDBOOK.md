...
รายละเอียดเชิงลึกอยู่ที่ skill pack: `skills/request-control-tower-advisor/`
...
รายละเอียดเต็ม: `skills/request-control-tower-advisor/references/02-dashboard-metric-definitions.md`
...
skills/request-control-tower-advisor/
  SKILL.md
  references/
    ...
    04-sla-rules.md
    05-ui-design-rules.md
    06-safe-implementation-rules.md
    07-cursor-prompt-patterns.md
    08-redteam-premortem-checklist.md
    09-editing-map.md
...
รายละเอียด: `skills/request-control-tower-advisor/references/06-safe-implementation-rules.md`
...
แผนที่เต็ม: `skills/request-control-tower-advisor/references/09-editing-map.md`
...
รายละเอียด: `skills/request-control-tower-advisor/references/04-sla-rules.md`

---

## 7. Checklist ก่อนขึ้น production

ใช้ `skills/request-control-tower-advisor/references/08-redteam-premortem-checklist.md`
...
คัดลอกจาก `skills/request-control-tower-advisor/references/07-cursor-prompt-patterns.md` หรือใช้แบบสั้น:

```text
Read CLAUDE.md and all files in skills/request-control-tower-advisor

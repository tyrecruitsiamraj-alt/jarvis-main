...
| `api/_handlers/job-staff.ts` | **ใหม่ใน handler เดิม** — `directory` = ชื่อเล่น + สายงาน + เบอร์ จาก `users` (110 + 114) · ส่งทุกคนที่ตั้งสายงานไว้ แม้ยังไม่มีเบอร์ · ผูก BU ชุดเดียวกับ roster |
...
| `src/pages/settings/AdminSettings.tsx` | ช่องชื่อเล่น/เบอร์ใส่ `min-w-` (ของเดิม `w-40` โดนตารางบีบเหลือ 38px) · ย้ายคอลัมน์เบอร์มาติดชื่อเล่น/สายงาน |

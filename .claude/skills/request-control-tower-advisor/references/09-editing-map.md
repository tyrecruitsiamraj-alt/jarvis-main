...
### 🔴 ช่องที่ยังเหลือ (รอเจ้าของสั่ง)
ใบล่วงหน้าที่ **ถูกแปลงเป็นใบขอจริงภายหลัง** — ของที่กรอกไว้ตอนเป็นใบล่วงหน้าอยู่คีย์
`siamraj-pre:<เลข>` ส่วนใบจริงอ่านเลขเปล่า ⇒ ของไม่ตามไป · จะให้ "ใบจริงที่ยังไม่มีของของตัวเอง
ตกไปอ่านของใบล่วงหน้าเลขเดียวกัน" ก็ได้ แต่นั่นคือเปิดทางให้สองใบปนกันอีก — **ต้องให้เจ้าของเคาะ**

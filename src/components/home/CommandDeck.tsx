...
/* 🔴 **หุ่นยนต์ถูกถอดออกจากหน้าแรก** (เจ้าของสั่ง 15 ก.ย. 2569:
 * *"หน้าแรกเอาหุ่นยนต์ออกให้หน่อย"*)
 * ไฟล์ภาพ `public/robot-mascot.webp` / `.png` **ยังอยู่ในโปรเจกต์** — ถอดเฉพาะการแสดงผล
 * อยากได้กลับมาให้ใส่ `<img>` คืน ไม่ต้องไปทำไฟล์ใหม่
 */
...
const CommandDeck: React.FC<{
  ...
  return (
    ...
    >
      ...
      {/* ⚠️ เดิมมีสามคอลัมน์ (หน้าปัด · งาน · หุ่นยนต์) — ถอดหุ่นออกแล้วเหลือสอง
          ต้องลบคอลัมน์ที่สามของ grid ด้วย ไม่งั้นเหลือช่องว่างค้างทางขวาบนจอกว้าง */}

      ...
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          ...
          <p className={cn('text-[11px]', DASH.muted)}>
            สายที่ 1/2/3 = ลำดับสายของคนนั้น ตามที่เลือกไว้ตอนเพิ่ม (วันเวลาแต่ละสายตั้งเองได้
            ไม่มีระยะห่างตายตัว) · กดสายไหนก็เห็นเฉพาะคนที่อยู่สายนั้น แล้วกดกล่องเพื่อดูรายชื่อ
          </p>
        </div>

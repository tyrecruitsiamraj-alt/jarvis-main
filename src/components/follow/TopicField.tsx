...
export default function TopicField({
  ...
  return (
    <FollowMasterSelect<FollowTopic>
      ...
      toValue={(t) => t.name}
      /**
       * 🔴 ต่อคำอธิบายท้ายชื่อในตัวเลือก (12 ก.ย. 2569) — ตาใหม่เห็น 3 เรื่องแล้วถามว่า
       * *"ต่างกันไหม เลือกแบบไหนตอนไหน"* · เรื่องนี้ไปโผล่ในบทพูดของ AI เลือกผิด =
       * โทรไปพูดผิดเรื่องกับคนจริง
       * ⚠️ `<select>` ของเบราว์เซอร์แสดงได้บรรทัดเดียว จึงต่อท้ายด้วย " — " ไม่ใช่ขึ้นบรรทัดใหม่

...
export const mockEmployees: Employee[] = [
  { id: 'e1', employee_code: 'EMP-001', title_prefix: 'นาย', first_name: 'สมบูรณ์', last_name: 'เทียมปาน', nickname: 'ชาย', phone: '061-914-9292', status: 'active', position: 'พนักงานขับรถ', join_date: '2023-06-01', address: 'อำเภอ/เขต เมือง จังหวัด นนทบุรี', base_salary: 11160, reliability_score: 92, utilization_rate: 85, total_days_worked: 220, total_income: 264000, total_cost: 176000, total_issues: 3, created_at: '2023-06-01' },
  { id: 'e2', employee_code: 'EMP-002', title_prefix: 'นางสาว', first_name: 'สมหญิง', last_name: 'รักษ์ดี', nickname: 'หญิง', phone: '081-222-2222', status: 'active', position: 'พนักงานต้อนรับ', join_date: '2023-08-15', address: 'เขตจตุจักร กรุงเทพฯ', base_salary: 12000, reliability_score: 88, utilization_rate: 78, total_days_worked: 180, total_income: 216000, total_cost: 144000, total_issues: 5, created_at: '2023-08-15' },

        ...
        <div className="rounded-2xl border border-border bg-card p-3 shadow-sm dark:bg-slate-900">
          ...
          <div className="flex flex-col gap-2 md:flex-row">
            ...
            <button
              ...
              onClick={() => void onAdd()}
              disabled={saving}
              className="inline-flex shrink-0 items-center justify-center gap-1.5 rounded-xl bg-primary px-4 py-2 text-sm font-medium text-primary-foreground disabled:opacity-60"
            >
                    ...
                    {editingId === row.id ? (
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="shrink-0 rounded-xl bg-primary px-3 text-xs font-medium text-primary-foreground"
                        >
                          บันทึก
                        </button>
                        <button
                          ...
                          className="shrink-0 rounded-xl border border-border px-3 text-xs font-medium"
                        >
                          ยกเลิก
                        </button>
                      </div>

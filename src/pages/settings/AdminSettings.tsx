                    ...
                    <tr key={u.id} className="border-b border-border/50 hover:bg-secondary/20">
                      ...
                      <td className="px-4 py-3">
                        <Input
                          ...
                          maxLength={60}
                          title="ชื่อเล่นที่ใช้เรียกกันจริง — ลิสต์ผู้รับผิดชอบบนใบขอและช่องเจ้าหน้าที่หน้าติดตามดึงชื่อจากช่องนี้"
                        ...
                        />
                        {/* 🔴 ตั้งสายงานไว้แต่ไม่มีชื่อเล่น = **ไม่โผล่ที่ไหนเลย** (23 ก.ย. 2569)
                            ลิสต์ใช้ชื่อเล่นอย่างเดียว ไม่มีทางถอยเป็นชื่ออังกฤษอีกแล้ว
                            ⇒ ต้องบอกตรงนี้ ไม่งั้นคนติ๊กสายงานแล้วรอชื่อที่ไม่มีวันขึ้น */}
                        {!u.nickname && (u.job_lanes ?? []).length > 0 ? (
                          <p className="mt-1 text-[11px] text-amber-700 dark:text-amber-300">
                            ยังไม่มีชื่อเล่น — ชื่อจะไม่โผล่ในลิสต์ผู้รับผิดชอบ
                          </p>
                        ) : null}
                      </td>

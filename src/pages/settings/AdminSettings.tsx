...
import { Users, Shield, Database, FileText, Palette, UserCog, ListChecks, ToggleLeft } from 'lucide-react';
...
import FeatureFlagsTab from '@/pages/settings/FeatureFlagsTab';
...
type SettingsTab = 'appearance' | 'users' | 'roles' | 'jobStaff' | 'workStatus' | 'features' | 'reference' | 'audit';
...
const allTabs: { id: SettingsTab; label: string; icon: React.ElementType; adminOnly: boolean }[] = [
  ...
  { id: 'features', label: 'เปิด/ปิดฟีเจอร์', icon: ToggleLeft, adminOnly: true },

...
const BrandingAppearanceTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="glass-card rounded-3xl p-4 md:p-6 border border-white/70 space-y-4">
        <h3 className="text-sm font-medium text-foreground">สีหลัก (ปุ่ม ลิงก์ ไฮไลต์)</h3>
      ...
      <div className="glass-card rounded-3xl p-4 md:p-6 border border-white/70 space-y-4">
        <h3 className="text-sm font-medium text-foreground">สีพื้นหลังและข้อความ</h3>
      ...
      <div className="glass-card rounded-3xl p-4 md:p-6 border border-white/70 space-y-4">
        <h3 className="text-sm font-medium text-foreground">พื้นหลังหน้าจอ</h3>

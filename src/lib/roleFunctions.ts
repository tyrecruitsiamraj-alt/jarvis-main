...
export const APP_FUNCTIONS: AppFunctionDef[] = [
  ...
  /**
   * เดิมตั้งต้นเป็น supervisor ตอนฟีเจอร์ยังใหม่ · **ลดเป็น staff 2 ก.ย. 2569** ตามที่เจ้าของสั่ง
   * (*"Staff ก็ทำได้ แก้เลย"*)
   *
   * ⚠️ ฟังก์ชันนี้คุมแค่ **แถบเครื่องมือบนกล่องงาน** (สร้างลิงก์ประกาศลอย + เหตุผล)
   * ส่วนปุ่มปล่อยประกาศขึ้นหน้าสาธารณะบนการ์ดใบขอ **ไม่เคยผูกกับฟังก์ชันนี้** และ

 ...
 *
 * ⚠️ **ตัวเลขมาจากฐานเรา (`public_job_applications`) เท่านั้น** — เจ้าของสั่ง
 * 12 ส.ค. 2569: "ไม่ได้ให้เอา database จาก iRecruit มา ฉันจะเริ่มเก็บรายชื่อใหม่เลย"
 * (เดิมอ่านจาก iRecruit แล้วแผงขึ้นเป็นแสน ทั้งที่ฐานเรายังไม่เริ่มเก็บ)
 * ช่องที่ฝั่งเรายังไม่เก็บ (ไม่รับสาย/นัดหมาย/ติดตามนัด) เป็น 0 จนกว่าจะมีตาราง
 * บันทึกผลติดต่อรายครั้ง — ดูการแมปที่ `api/_handlers/recruit-funnel.ts`
 *

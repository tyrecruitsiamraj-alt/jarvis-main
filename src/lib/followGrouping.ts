 ...
 * เดิมคีย์เป็น `เบอร์|เรื่อง` เฉย ๆ ⇒ **คนละคนที่ใช้เบอร์เดียวกัน** (เบอร์กลางของไซต์ ·
 * คนในบ้านเดียวกัน · ข้อมูลทดสอบ) ถูกยุบเป็นแถวเดียว แล้วโชว์ชื่อของรอบล่าสุด
 * คนอื่นหายเข้าไปในป้าย "+N" · ที่แย่กว่าหายคือ **เวลานัดของคนหนึ่งไปแปะชื่ออีกคน**
 * (ของจริงที่เจอ: เบอร์ +66922511703 ยุบ 3 ชื่อเป็นแถวเดียว · +66898143230 ยุบ 2 ชื่อ)
 * ⚠️ ผลข้างเคียงที่ยอมรับแล้ว: คนเดิมที่ **แก้สะกดชื่อ** จะกลายเป็นสองการ์ด
 *    (เทียบกับความเสี่ยงโทรผิดคน — เจ้าของเลือกทางนี้) · การเทียบตัดช่องว่างหัวท้าย
 *    และยุบช่องว่างซ้ำให้แล้ว สะกดต่างจริงเท่านั้นถึงแยก
 *
...
/**
 * ชื่อสำหรับเทียบว่าเป็นคนเดียวกันไหม — ตัดช่องว่างหัวท้าย + ยุบช่องว่างซ้ำเป็นช่องเดียว
 * (พิมพ์เว้นวรรคเกินไม่ควรกลายเป็นคนละคน) · ตัวพิมพ์เล็ก/ใหญ่ของอังกฤษถือว่าเท่ากัน
 */

...
/**
 * ═══ BU ของรายการติดตาม = **แผนกของคนคีย์** ═══
 *
 * เจ้าของเคาะ 15 ก.ย. 2569 (หลังผมเสนอให้ใช้ไซต์ก่อน แล้วเขาตีตก):
 * *"ไม่ จะไม่ให้คีย์แทนสิ แยกกันไว้แล้วจะคีย์แทนกันทำไม นับจากคนคีย์ไปเลย"*
 *
 * ⇒ **งานติดตามเป็นงานของแผนกที่คีย์** ไม่ใช่ของไซต์ · แต่ละแผนกดูแลคนของตัวเอง
 * คีย์ข้ามแผนกไม่ใช่สิ่งที่อนุญาตอยู่แล้ว จึงไม่ต้องเผื่อกรณีนั้นในตัวเลข
 *
 * ⚠️ ไซต์เหลือเป็น **ทางถอยอย่างเดียว** — ใช้เมื่อคนคีย์ไม่มีแผนกในระบบ
 * (เช่น แถวที่ระบบสร้างเอง หรือคนที่ยังไม่ถูกจัดแผนก) ไม่ใช่เพื่อทับการตัดสินของคน
 *
 * วัดกับข้อมูลจริงวันที่เคาะ: 54 แถว — จากไซต์ LBD 40 · ไม่มีไซต์ 14 ·
 * **คนคีย์เป็น LBD ทั้ง 54 แถว** ⇒ สลับมาใช้คนคีย์แล้วเลขไม่เปลี่ยน แต่เลิกมีช่อง "ไม่รู้"
 */
